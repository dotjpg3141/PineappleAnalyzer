...
namespace PineappleAnalyzer.CodeAnalysis.Analyzer
{
    ...
    public class RequiredDefaultSwitchLabelAnalyzerTest : DiagnosticVerifier
    {
        ...
        [TestMethod]
        public void CasePatternSwitchLabel_VarPattern()
        {
            var source = @"
                namespace ConsoleApplication1
                {
        ...
        [TestMethod]
        public void CasePatternSwitchLabel_VarPattern_WhenCondition()
        {
            var source = @"
                namespace ConsoleApplication1
                {
        ...
        [TestMethod]
        public void CasePatternSwitchLabel_VarPattern_WhenCondition_IsConstant_True()
        {
            var source = @"
                namespace ConsoleApplication1
                {
